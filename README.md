...
| 11 | Valid Anagram: https://leetcode.com/problems/valid-anagram/ | Strings | Easy | 20 min | 1 | No | Use hash_map to store distinct letters with the number of time they're appearing in the string. If equals it means it's an anagram. | Solved |
| 12 | Valid Palindrome | Strings | Easy | 15 min | 2 | No | None | Solved |
